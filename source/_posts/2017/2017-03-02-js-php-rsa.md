...
_tmpUrl: https://blog.lopy.win
_tmpGitHubUrl: https://github.com/uljjmhn520/uljjmhn520.github.io
---
...
本 blog 也拷贝了这几个库，网址的目录为： [http://blog.lopy.win/assets/rsa/](http://blog.lopy.win/assets/rsa) ，将几个文件名加在后面就可以了。


<a href="{{ _tmpGitHubUrl }}/tree/hexo-source/themes/next/source/js/src/rsa">github地址</a>
...
<!-- 本blog的js文件 -->
<script src="{{ _tmpUrl }}/js/src/rsa/jsbn.js"></script>
<script src="{{ _tmpUrl }}/js/src/rsa/prng4.js"></script>
<script src="{{ _tmpUrl }}/js/src/rsa/rng.js"></script>
<script src="{{ _tmpUrl }}/js/src/rsa/rsa.js"></script>
<script src="{{ _tmpUrl }}/js/src/rsa/base64.js"></script>
{% endcodeblock %}
...
## 官方说明
 ...
 php的openssl 扩展官网 [点击进入](http://php.net/manual/en/ref.openssl.php)
